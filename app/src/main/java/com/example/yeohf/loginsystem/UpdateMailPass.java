...
public class UpdateMailPass extends AppCompatActivity {
                ...
                firebaseUser.updateEmail(usernewmail).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            Toast.makeText(UpdateMailPass.this,"Email Changed!",Toast.LENGTH_SHORT).show();
                        }
                        else{
                            Toast.makeText(UpdateMailPass.this,"Emailchange Failed!",Toast.LENGTH_SHORT).show();
        ...
        updatePass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                firebaseUser.updatePassword(usernewpass).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            Toast.makeText(UpdateMailPass.this,"Password Changed!",Toast.LENGTH_SHORT).show();
                        }
                        else{
                            Toast.makeText(UpdateMailPass.this,"Passwordchange Failed!",Toast.LENGTH_SHORT).show();
                        }
                    }
                });
